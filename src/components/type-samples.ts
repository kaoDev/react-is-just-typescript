...
type Shared<
  InjectedProps,
  DecorationTargetProps extends Shared<
    InjectedProps,
...
> {
  ...
  <P extends Shared<TInjectedProps, P>>(
    ...
    Omit<P, keyof Shared<TInjectedProps, P>> &
      TNeedsProps
...
interface MapStateToPropsFactory<
  TStateProps,
  TOwnProps,
  State
> {
...
interface MapDispatchToPropsFactory<
  TDispatchProps,
  TOwnProps
> {
  (
...
export class Provider<
  A extends Action = AnyAction
> extends Component<ProviderProps<A>> {}
